...
export const experience: WorkItem[] = [
  {
    id: 1,
    title: "Techincal Operations Intern @ Embarc Collective",
  ...
  },
{
  ...
  technologies: ["PHP", "PostgreSQL", "Google Cloud Storage", "Gemini", "Azure OpenAI"],
}
];